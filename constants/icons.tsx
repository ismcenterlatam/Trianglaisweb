...
export const InstagramIcon: React.FC<IconProps> = (props) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 4.267.218 2.377 2.112.228 4.918.073 6.196.014 6.6.014 9.833 0 13.067.059 13.475.228 16.273c.149 2.806 2.039 4.7 4.825 4.849 1.278.058 1.686.072 4.947.072 3.26 0 3.669-.014 4.947-.072 2.786-.149 4.676-2.043 4.825-4.849.058-1.278.072-1.686.072-4.947s-.014-3.669-.072-4.947c-.149-2.806-2.039-4.7-4.825-4.849C15.333.014 14.925 0 11.667 0H12zM12 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.88 1.44 1.44 0 000-2.88z" />
    </svg>
);
...
export const QuoteIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l-1.5 1.5-1.5-1.5M11.25 4.5l1.5 1.5 1.5-1.5M11.25 4.5v15m-3.375-10.5h-1.5a1.125 1.125 0 00-1.125 1.125v1.5a1.125 1.125 0 001.125 1.125h1.5m3.375-4.5h1.5a1.125 1.125 0 011.125 1.125v1.5a1.125 1.125 0 01-1.125 1.125h-1.5m-3.375-15l1.5 1.5 1.5-1.5m0 0l-1.5 1.5-1.5-1.5m0 0v15" />
    </svg>
);
...
export const CalendarDaysIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zm0 4.5h.008v.008H12v-.008zm-4.5-4.5h.008v.008H7.5v-.008zm0 4.5h.008v.008H7.5v-.008zm-2.25-4.5h.008v.008H5.25v-.008zm4.5 0h.008v.008H9.75v-.008zm4.5 0h.008v.008H14.25v-.008zm2.25 0h.008v.008H16.5v-.008z" />
  </svg>
);

export const RocketLaunchIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.63 2.18a14.98 14.98 0 00-12.12 6.16.98.98 0 00.327 1.21l1.21.327a.98.98 0 001.21-.327A6 6 0 0114.37 15.59a.98.98 0 001.21.327l.327 1.21a.98.98 0 001.21-.327zM6 18.75a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H6.75a.75.75 0 01-.75-.75V18.75z" />
    </svg>
);
...
export const ServerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 17.25v-.228a4.5 4.5 0 00-.12-1.03l-2.268-9.64a3.375 3.375 0 00-3.285-2.65H8.228a3.375 3.375 0 00-3.285 2.65l-2.268 9.64a4.5 4.5 0 00-.12 1.03v.228m15.54 0a2.25 2.25 0 01-2.25 2.25H4.5a2.25 2.25 0 01-2.25-2.25m15.54 0v-1.17a3.375 3.375 0 00-3.375-3.375H5.625a3.375 3.375 0 00-3.375 3.375v1.17m15.54 0a2.25 2.25 0 01-2.25 2.25H4.5a2.25 2.25 0 01-2.25-2.25M12 18.75a.75.75 0 00.75.75h.008a.75.75 0 00.75-.75V18a.75.75 0 00-.75-.75h-.008a.75.75 0 00-.75.75v.75z" />
    </svg>
);
