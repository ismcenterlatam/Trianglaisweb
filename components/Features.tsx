...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description }) => (
  <div className="bg-brand-dark/50 backdrop-blur-sm p-8 rounded-lg shadow-lg border border-brand-slate/20 hover:border-brand-accent/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
